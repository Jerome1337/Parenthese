...
<html lang="fr-FR" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb#">
        ...
        <meta property="og:url" content="http://bicravart.com/fbshare/graff-3590226625">
    ...
    <body>
        <section class="fullWidth">
            ...
            <div class="rightBar" id="drawerContainer">
                <img src="../img/graff/graff-3590226625.png" alt="Graff numéro 3590226625">
            </div>
        </section>
        ...
        <script>
            function launchShare() {
                var lien = 'http://bicravart.com/fbshare/graff-3590226625';
                FB.ui({
                    method: 'share',
                    display: 'popup',
                    href: lien
